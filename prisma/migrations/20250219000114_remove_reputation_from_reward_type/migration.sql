/*
  ...
  - The values [REP] on the enum `RewardType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RewardType_new" AS ENUM ('STARS', 'XP');
