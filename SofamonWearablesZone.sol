...
contract SofamonWearablesZone is Initializable, Ownable {
    ...
    function initialize(address _wearableOperator, address _signer, address _zoneToken) public {
    ...
    function _buyWearables(bytes32 wearablesSubject, uint256 amount, bool isPublic) internal {
        ...
        bool success2 = zoneToken.transferFrom(address(this), protocolFeeDestination, protocolFee);
        bool success3 = zoneToken.transferFrom(address(this), creatorFeeDestination, creatorFee);
    ...
    function _sellWearables(bytes32 wearablesSubject, uint256 amount, bool isPublic) internal {
        ...
        bool success1 = zoneToken.transferFrom(address(this), msg.sender, price - protocolFee - creatorFee);
        bool success2 = zoneToken.transferFrom(address(this), protocolFeeDestination, protocolFee);
        bool success3 = zoneToken.transferFrom(address(this), creatorFeeDestination, creatorFee);
